...
const styles = StyleSheet.create({
  ...
  markText: { fontSize: 24, color: '#D9A5A0', fontWeight: '700', fontFamily: 'PlayfairDisplay_700Bold' },
  title: { fontSize: 23, lineHeight: 29, fontWeight: '700', fontFamily: 'PlayfairDisplay_700Bold', color: '#F3ECE4', textAlign: 'center' },
