...
const styles = StyleSheet.create({
  ...
  markText: { fontSize: 24, color: '#6645D9', fontWeight: '700', fontFamily: 'PlayfairDisplay_700Bold' },
  title: { fontSize: 23, lineHeight: 29, fontWeight: '700', fontFamily: 'PlayfairDisplay_700Bold', color: '#211C33', textAlign: 'center' },
  body: { fontSize: 15, lineHeight: 22, color: '#565170', textAlign: 'center' },
  retry: {
    marginTop: 8,
    width: '100%',
    alignItems: 'center',
